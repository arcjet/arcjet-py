...
import arcjet._dataclasses as _dc
...
class IpInfo:
    ...
    @property
    def details(self) -> _dc.IpDetails | None:
...
@dataclass(frozen=True, slots=True)
@deprecated("Use the `reason_v2` property instead.")
class Reason:
...
class Decision:
    ...
    @property
    def ip_details(self) -> _dc.IpDetails | None:
