...
class Arcjet:
    ...
    async def protect(
        ...
        *,
        ...
        - request_ip: Override automatic IP detection. Required when
        ...
        # When automatic IP detection is disabled, require request_ip parameter
...
def arcjet(
    *,
    ...
    - `disable_automatic_ip_detection`: When True, automatic IP detection is
        disabled and `request_ip` must be provided to `protect()`.
    """
    if not key:
