...
from the WASM binary. This requires [`wasm-tools`](https://github.com/bytecodealliance/wasm-tools)
on PATH (included in the devcontainer, or install with `cargo install wasm-tools`).
